var _analytics = (function (exports) {
  ...
  function hn(n) {
    return (
      n instanceof Error ||
      (q$1(n.message) && n.constructor && nn(n.constructor.stackTraceLimit))
    );
  }
  ...
  function s(r) {
    return (function (e) {
      for (
        var r, t = Object.create(null), o = /([^&=]+)=?([^&]*)/g;
        (r = o.exec(e));
        ...
        "[]" === a.substring(a.length - 2)
          ? (t[(a = a.substring(0, a.length - 2))] || (t[a] = [])).push(i)
          : (t[a] = "" === i || i);
      }
  ...
  function y$1() {
    for (var e = "", r = 0, t = (4294967295 * Math.random()) | 0; r++ < 36; ) {
      var n = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx"[r - 1],
        o = 15 & t;
      (e +=
        "-" == n || "4" == n ? n : ("x" == n ? o : (3 & o) | 8).toString(16)),
        (t = r % 8 == 0 ? (4294967295 * Math.random()) | 0 : t >> 4);
    }
  ...
  var l = "global",
    o = j$1 + "global" + j$1,
    n =
      (typeof self === o$1 && self.self === self && self) ||
      (typeof global === o$1 && global.global === global && global) ||
      void 0;
  ...
  function w(e, t, n) {
    ...
    if (
      (typeof t === h$1 && typeof n === v && ((n = t), (t = void 0)),
      typeof n !== v)
    ) {
        ...
        return function (i) {
          if (i.type === z.bootstrap) {
            var a = i.params,
              ...
              c = i.initialUser,
              s = u.userId === o.userId;
            u.anonymousId !== o.anonymousId && t(N$1, o.anonymousId),
              s || t(A$1, o.userId),
              c.traits &&
                t(_, g$1({}, s && u.traits ? u.traits : {}, c.traits));
              ...
              var f = a.an_uid,
                ...
                p = l.reduce(
                  function (e, t) {
                    ...
                    return (
                      t.match(q) && (e.props[t.replace(q, "")] = a[t]),
                      t.match(V) && (e.traits[t.replace(V, "")] = a[t]),
                      e
                    );
                  },
                  {
        ...
        var v = (function (e, t) {
            return function (n, r, i) {
              ...
              var c = n.type.match(W)
                ...
                : (function (e, t) {
                    return function () {
                      throw new Error(
                        e.type + " action not cancellable. Remove abort in " + t
                      );
                    };
                  })(n, u);
              return {
          ...
          y = t.exact.reduce(function (e, t) {
            var n = t.pluginName,
              ...
              i = !1;
            return (
              r.match(/^initialize/) || r.match(/^reset/) || (i = !f[n].loaded),
              d.offline && r.match(/^(page|track|identify)/) && (i = !0),
              (e["" + n] = i),
              e
            );
          }, {});
        ...
        return Promise.resolve(
          t.exact.reduce(function (e, i, o) {
            try {
              ...
              return Promise.resolve(e).then(function (e) {
                ...
                var o = (function () {
                  if (t.namespaced && t.namespaced[u])
                    return Promise.resolve(
                      t.namespaced[u].reduce(function (e, t, n) {
                        try {
                          return Promise.resolve(e).then(function (e) {
                            return t.method && W$1(t.method)
                              ? ((function (e, t) {
                                  var n = ie(e);
          ...
          return Promise.resolve(
            ...
            if (
              !(
                p.match(W) ||
                p.match(/^registerPlugin/) ||
                p.match(G$1) ||
                p.match(F$1) ||
                p.match(/^params/) ||
                p.match(/^userIdChanged/)
              )
            ) {
              if ((s.plugins.includes(p), e._ && e._.originalAction === p))
                return e;
              var n = g$1({}, e, {
                _: {
  ...
  function ae(e) {
    return Object.keys(e).reduce(function (t, n) {
      return (
        "type" === n || (t[n] = on(e[n]) ? Object.assign({}, e[n]) : e[n]), t
      );
    }, {});
  }
                    ...
                    (function (e, t, n, r, i) {
                      try {
                        ...
                        var c = n.getState(),
                          s =
                            ((m = a),
                            void 0 === (h = c.plugins) && (h = {}),
                            void 0 === (v = e.options) && (v = {}),
                            Object.keys(m)
                              .filter(function (e) {
                                var t = v.plugins || {};
                                return Q$1(t[e])
        ...
        l = (function (e) {
          ...
          return t
            ? t.match(/\?/)
              ? t
              : t + e
            : window.location.href.replace(ve, "");
        })(s),
        f = {
          title: n,
          url: l,
    ...
    var u = o.reducers || {},
      ...
      b = (function (e) {
        return function (t, n, i) {
          return (
            n.getState("user")[t] ||
            (i && on(i) && i[t] ? i[t] : R(e)[t] || a$2($(t)) || null)
          );
        };
      })(m),
      I = f$1.plugins,
      A = f$1.events
        ...
        .sort(),
      _ = new Set(
        A.concat(x$1).filter(function (e) {
          return !T.includes(e);
        })
      ),
      O = Array.from(_).sort(),
  ...
  function L(r$2, a$1, l$1) {
    if (r$2 && !I$2(a$1)) {
      var u = {},
        ...
        S = !N(g);
      return d(g) &&
        ((u[r] = F(r, a$1, I(localStorage.getItem(r$2)))),
        localStorage.setItem(r$2, m),
        S)
        ? u[r]
        : h(g) && ((u[t] = F(t, a$1, I(r$1(r$2)))), c(r$2, m), S)
        ? u[t]
        : E(g) &&
          ((u[a] = F(a, a$1, I(sessionStorage.getItem(r$2)))),
          sessionStorage.setItem(r$2, m),
          S)
        ? u[a]
        : ((u[l] = F(l, a$1, a$2(r$2))), f(r$2, a$1), S ? u[l] : u);
    }
  }
  ...
  function b(t$1, e) {
    if (t$1) {
      ...
      return (
        !I$2(s.localStorage) &&
          d(a$1) &&
          (localStorage.removeItem(t$1), (n[r] = s.localStorage)),
        !I$2(s.cookie) && h(a$1) && (u(t$1), (n[t] = s.cookie)),
        !I$2(s.sessionStorage) &&
          E(a$1) &&
          (sessionStorage.removeItem(t$1), (n[a] = s.sessionStorage)),
        !I$2(s.global) && G(a$1, l) && (i$2(t$1), (n[l] = s.global)),
        n
      );
    }
  }
